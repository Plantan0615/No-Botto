...
module.exports.help = {
    ...
    description: "Type this command to see how many warnings you have, and the reasons for those warnings (This command will only work if you have sent a non-command message. Type ~help economy for more info.)"
}