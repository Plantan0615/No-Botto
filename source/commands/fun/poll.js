...
module.exports = {
    ...
    help: {
        ...
        description: [
            ...
            { name: "Step 2", value: "Copy the ID of the message you just sent (You will need developer tools on for this. Go to settings, then appearance (behaviour if you're on mobile), and turn it on). Type the poll command and paste the ID (in the same message). (Type '~help fun usage' if you need an example of what to type for this step)"},
